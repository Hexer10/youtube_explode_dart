...
class ClosedCaptionClient {
  ...
  Future<ClosedCaptionManifest> getManifest(dynamic videoId,
      {@Deprecated(
          'Not used anymore, use track.isAutoGenerated to see if a track is autogenerated or not.',) // ignore: lines_longer_than_80_chars
  ...
  Future<ClosedCaptionTrack> get(ClosedCaptionTrackInfo trackInfo) async {
    final response = await re.ClosedCaptionClient.get(_httpClient, trackInfo.url);

    final captions = response.closedCaptions
